...
<div class="d-flex">
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <h5 class="text-white mt-3">🔹 Quản lý tác giả</h5>
            <li class="nav-item"><a class="nav-link text-white" href="?page=authors">Tác giả</a></li>

            <h5 class="text-white mt-3">🔹 Quản lý nhà cung cấp</h5>
            <li class="nav-item"><a class="nav-link text-white" href="?page=publishers">Nhà cung cấp</a></li>
...
//                break;
        ...
        case 'books':
            ...
            break;
        case 'authors':
            include 'Layout/Master/authors.php';
            break;
        case 'publishers':
            include 'Layout/Master/publishers.php';
            break;
        case 'orders':
